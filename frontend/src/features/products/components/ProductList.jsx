...
export const ProductList = () => {
    ...
    const handleBrandFilters=(e)=>{
        ...
        const existingBrands = filters.brand || []
        const filterSet=new Set(existingBrands)
    ...
    const handleCategoryFilters=(e)=>{
        const existingCategories = filters.category || []
        const filterSet=new Set(existingCategories)
